...
public partial class GameEntity {
    ...
    public void AddProjectile(UnityEngine.Vector3 newDirection, float newSpeed) {
    ...
    public void ReplaceProjectile(UnityEngine.Vector3 newDirection, float newSpeed) {
        var index = GameComponentsLookup.Projectile;
        var component = (ProjectileComponent)CreateComponent(index, typeof(ProjectileComponent));
        component.direction = newDirection;
        component.speed = newSpeed;
